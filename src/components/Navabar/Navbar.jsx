...
const handletoggle =(e)=>{
      ...
      {user ? (
        ...
        >
          <div className="flex flex-row justify-center items-center gap-2 text-theme-dark relative">
            ...
            <p className="absolute -top-1 left-3 text-[#A83A49] font-bold">
              +{cart?.length || 0}
            </p>
            Dashoboard
          </div>
  ...
  return (
    <div>
      <div className="navbar bg-transparent my-container   justify-between">
        <div className="navbar-start">
          ...
          <img
            src="https://i.ibb.co/dcWpWjP/logo.png"
            alt=""
            className="w-1/2"
          />
   ...
   <label className="swap swap-rotate my-auto mx-auto ml-3 ">
          <input type="checkbox"  onChange={handletoggle} className="w-0 p-0 " />

          <svg
            className="swap-on fill-theme-1 w-8 h-8"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
          ...
          <svg
            className="swap-off fill-theme-1 w-8 h-8"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
